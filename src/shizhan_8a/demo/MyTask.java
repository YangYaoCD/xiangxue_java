package shizhan_8a.demo;

import shizhan_8a.vo.ITaskProcesser;
import shizhan_8a.vo.TaskResult;
import shizhan_8a.vo.TaskResultType;
...
public class MyTask implements ITaskProcesser<Integer,Integer> {
	...
	public TaskResult<Integer> taskExecute(Integer data) {
		...
		if(flag<=300) {//正常处理的情况
			...
			return new TaskResult<Integer>(TaskResultType.Failture,-1,"Failure");
		}else {//发生异常的情况
			try {
